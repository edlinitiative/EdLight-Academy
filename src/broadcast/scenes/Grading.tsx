...
/**
 * Sequence 16 — CALCUL DES SCORES. Deliberately withholds. The ray field sweeps once per second.
 *
 ...
 */
export default function Grading({ scene, reduceMotion, t }: SceneProps) {
