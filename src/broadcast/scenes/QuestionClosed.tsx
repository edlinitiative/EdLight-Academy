...
/**
 * Sequence 5 — the board brightens, % correct fills as a hairline, the fastest answer is named.
 *
 ...
 */
export default function QuestionClosed({ scene, reduceMotion, t }: SceneProps) {
