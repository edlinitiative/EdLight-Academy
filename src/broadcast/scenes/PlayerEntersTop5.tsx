...
/**
 * Sequence 8 — five slots; the incoming card slides into the vacated one while the outgoing fades. A substitution.
 *
 ...
 */
export default function PlayerEntersTop5({ scene, reduceMotion, t }: SceneProps) {
