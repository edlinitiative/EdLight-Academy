...
export const GAMES: GameDef[] = [
  ...
  },
  {
    ...
    name: 'Vrai ou Faux',
    nameHt: 'Vre oswa Fo',
    description: 'Une réponse proposée, 60 secondes — décidez vite : vraie ou fausse ?',
    descriptionHt: 'Yon repons pwopoze, 60 segonn — deside vit: vre oswa fo ?',
    color: '#e0532f',
    minutes: 2,
  },
  {
    ...
    name: 'Mémoire',
    nameHt: 'Memwa',
    description: 'Retrouvez les paires pays-capitale en un minimum de coups.',
    descriptionHt: 'Jwenn pè peyi-kapital yo ak mwens mouvman posib.',
    color: '#7c3aed',
    minutes: 3,
  },
  {
